...
public class LoginPage {
    ...
    public static final Target USERNAME_FIELD = Target.the("input username").located(By.id("loginusername"));
    public static final Target PASSWORD_FIELD = Target.the("input password").located(By.id("loginpassword"));
